...
import static com.linhx.launcher3.LauncherState.FAST_OVERVIEW;
...
import static com.linhx.systemui.shared.system.NavigationBarCompat.HIT_TARGET_BACK;
import static com.linhx.systemui.shared.system.NavigationBarCompat.HIT_TARGET_ROTATION;
...
import com.linhx.launcher3.LauncherInitListener;
...
import com.linhx.launcher3.uioverrides.FastOverviewState;
...
import com.linhx.quickstep.util.LayoutUtils;
...
import com.linhx.quickstep.views.LauncherLayoutListener;
import com.linhx.quickstep.views.LauncherRecentsView;
...
public interface ActivityControlHelper<T extends BaseDraggingActivity> {
    ...
    /**
     * Used for containerType in {@link com.linhx.launcher3.logging.UserEventDispatcher}
     */
